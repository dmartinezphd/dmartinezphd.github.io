...
![Picture of Earthshine Prototype](/assets/images/earthshine-protype.png)
...
3. Get funding, get all of the proper licenses!
...
A good case study on high-precision pointing on a CubeSat can be found here (NASA, of course): https://science.nasa.gov/technology/technology-highlights/high-precision-pointing-on-a-cubesat-enables-new-science
